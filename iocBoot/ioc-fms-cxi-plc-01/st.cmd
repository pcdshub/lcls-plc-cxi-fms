...
epicsEnvSet("LOCATION", "FMS:CXI:PLC:01" )
...
dbLoadRecords("iocSoft.db", "IOC=FMS:CXI:PLC:01")
dbLoadRecords("save_restoreStatus.db", "P=FMS:CXI:PLC:01:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=FMS:CXI:PLC:01")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=FMS:CXI:PLC:01")
...
save_restoreSet_status_prefix( "FMS:CXI:PLC:01:" )
